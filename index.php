...
<html lang="en">
  <head>
    ...
    <title>Beauty Parlour Management System | House Page</title>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">A Royal Touch For Your Timeless Beauty</h4>
                            <p class="para ">Royal Beauty Salon Offers - Beauty Services</p>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					...
					<p class="para  text "> Discover the secret to timeless beauty at Royal Beauty Parlour where we treat every client like royality.Our expert teams delivers exceptional services tailoured to your unique needs in suring you leave feeling refreshe, confident, and absolutely radient. Vist us today and experience the royal difference in Beauty care.
						</p>
