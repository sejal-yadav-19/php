...
echo "<script>alert('This email or Contact Number already associated with another account!.');</script>";
        ...
        // **Check if password is already taken by another user**
        $checkPassword = mysqli_query($con, "select Password from tbluser where Password='$password'");
        $passResult = mysqli_fetch_array($checkPassword);
        if ($passResult > 0) {
            echo "<script>alert('This password is already taken by another user. Please choose another password.');</script>";
        }
